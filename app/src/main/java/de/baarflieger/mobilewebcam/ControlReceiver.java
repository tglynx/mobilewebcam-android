...
public class ControlReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
		...
		if(intent.getAction().equals("de.baarflieger.mobilewebcam.START"))
		{
			Start(context, prefs, intent.getStringExtra("event"));
		}
		else if(intent.getAction().equals("de.baarflieger.mobilewebcam.STOP"))
		{
			Stop(context, prefs);
		}
		else if(intent.getAction().equals("de.baarflieger.mobilewebcam.PHOTO"))
		{

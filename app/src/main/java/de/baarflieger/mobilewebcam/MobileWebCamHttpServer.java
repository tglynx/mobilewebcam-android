...
import de.baarflieger.mobilewebcam.PhotoSettings.BooleanPref;
import de.baarflieger.mobilewebcam.PhotoSettings.EditFloatPref;
import de.baarflieger.mobilewebcam.PhotoSettings.EditIntPref;
import de.baarflieger.mobilewebcam.PhotoSettings.IntPref;
import de.baarflieger.mobilewebcam.PhotoSettings.Mode;
import de.baarflieger.mobilewebcam.PhotoSettings.StringPref;
...
public class MobileWebCamHttpServer extends NanoHTTPD
{
	...
	public Response serve( String uri, String method, Properties header, Properties parms, Properties files )
	{
		...
		{
			Intent i = new Intent();
			i.setAction("de.baarflieger.mobilewebcam.START");
		...
		{
			Intent i = new Intent();
			i.setAction("de.baarflieger.mobilewebcam.STOP");
			mContext.sendBroadcast(i);
